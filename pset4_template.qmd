...
# Define the Texas and New Mexico ZIP code ranges
...
# Filter for New Mexico ZIP codes
zips_new_mexico_centroids = zips_all_centroids[zips_all_centroids['ZCTA5'].astype(int).isin(new_mexico_prefixes)]

# Count unique ZIP codes in each subset
texas_unique_zips = zips_texas_centroids['ZCTA5'].nunique()
new_mexico_unique_zips = zips_new_mexico_centroids['ZCTA5'].nunique()

print(f"Number of unique ZIP codes in Texas: {texas_unique_zips}")
print(f"Number of unique ZIP codes in New Mexico: {new_mexico_unique_zips}")

```

Number of unique ZIP codes in Texas: 1935
Number of unique ZIP codes in New Mexico: 368
